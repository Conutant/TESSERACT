...
if (! function_exists ( 'tesseract_setup' )) :
	...
	function tesseract_setup() {
		...
		/*
		 * Make theme available for translation. Translations can be filed in the /languages/ directory. If you're building a theme based on Tesseract, use a find and replace to change 'tesseract' to the name of your theme in all the template files
		 */
...
function register_my_menus() {
	...
	/*
	 * register_nav_menus( array( 'primary' => __( 'Primary Menu', 'tesseract' ), 'footermenu' => __( 'Footer Menu','tesseract' ) ) );
	 */
...
function tesseract_scripts() {
	...
	wp_enqueue_script ( 'tesseract-helpers', get_template_directory_uri () . '/js/helpers.js', array (
			'jquery'
	), '1.0.0', true );
...
/*
 * function test_css() { wp_add_inline_style('tesseract-style','h1 { color: #ff0000 !important;}'); } add_action('after_setup_theme', 'test_css');
 */
/**
