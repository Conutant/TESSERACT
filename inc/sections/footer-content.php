 ...
 */					 			
   	...
   	$wp_customize->add_section( 'tfo_footer_content' , array(
    	'title'      => __('Footer Content', 'tesseract'),
    	'priority'   => 3,
		'panel'      => 'tesseract_footer_options'
	) );	
	
		$wp_customize->add_setting( 'tfo_footer_content_header', array(
			'default'           => '',
			'type'           	=> 'option',
			'transport'         => 'refresh',
			...
			$wp_customize->add_control( 
				...
				$wp_customize,
				'tfo_footer_content_header_control', 
				array(
					'label' =>  __('Choose the content to be displayed in the footer', 'tesseract' ),
					'section' => 'tfo_footer_content',
					'settings' => 'tfo_footer_content_header',
					'priority' => 	1
					)
				)
			);						
			
		$wp_customize->add_setting( 'tfo_footer_additional_content', array(
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize,
					'tfo_footer_additional_content_control',
					array(
						'section'        => 'tfo_footer_content',
						'settings'       => 'tfo_footer_additional_content',
						'type'           => 'radio',
						'choices' 		 => array( 
							'nothing' 	 => 'Nothing',
							'logo' 		 => 'Logo',
		...
		$wp_customize->add_setting( 'tfo_footer_content_enable', array(
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					$wp_customize,
					'tfo_footer_content_enable_control',
					array(
